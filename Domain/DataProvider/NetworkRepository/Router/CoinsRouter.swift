...
enum CoinsRouter {
    ...
    func asURLRequest() throws -> URL? {
        ...
        switch self{
        case .coinsMarkets(
        let currency, let cryptoCurrency,
        let order, let perPage, let page, let percentage):
            ...
            return url.appendingQueryParameters(path: path,
        ...
        case .coinsByOhlc(_, let currency, let days):
            var parameters: [String: String] =
            [
                "vs_currency" : currency,
                "days" : days
